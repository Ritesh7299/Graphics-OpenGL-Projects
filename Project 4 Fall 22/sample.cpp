...
#define RAD 7.f
	...
	glPushMatrix();
		SetPointLight(GL_LIGHT1, 20., 10., 0., .5, .5, .5);
		if (Light1On)
			glEnable(GL_LIGHT1);
		else
			glDisable(GL_LIGHT1);
	...
	glPushMatrix();
		SetSpotLight(GL_LIGHT2, 10., 8., 10., 0.5, -1., 0., 1., 0., 0.);
		if (Light2On)
			glEnable(GL_LIGHT2);
		else
			glDisable(GL_LIGHT2);
	...
	DoRasterString( 0.f, 1.f, 0.f, (char *)"" );
	...
	DoRasterString( 5.f, 5.f, 0.f, (char *)"" );
